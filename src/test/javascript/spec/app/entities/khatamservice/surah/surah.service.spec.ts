...
describe('Service Tests', () => {
    describe('Surah Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SurahService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'khatamservice/api/surahs';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Surah', () => {
                service.create(new Surah(null)).subscribe(received => {
            ...
            it('should update a Surah', () => {
                service.update(new Surah(123)).subscribe(received => {
